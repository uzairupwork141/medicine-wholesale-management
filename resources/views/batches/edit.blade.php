                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('medicine_id')
                                    ? ($medicines->firstWhere('id', old('medicine_id'))->name ?? '')
                                    : ($batch->medicine->name ?? '') }}">
                        ...
                        <input type="hidden"
                               name="medicine_id"
                               id="medicine_id"
                               value="{{ old('medicine_id', $batch->medicine_id) }}">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number"
                               ...
                               value="{{ old('sale_price', $batch->sale_price) }}"
                               placeholder="0.00">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="status"
                            ...
                            <option value="Available"
                                {{ old('status', $batch->status) == 'Available'
                                    ? 'selected'
                                    : '' }}>
                                Available
                            </option>
                            ...
                            <option value="Expired"
                                {{ old('status', $batch->status) == 'Expired'
                                    ? 'selected'
                                    : '' }}>
                                Expired
                            </option>
                            ...
                            <option value="Quarantine"
                                {{ old('status', $batch->status) == 'Quarantine'
                                    ? 'selected'
                                    : '' }}>
                                Quarantine
                            </option>
...
<script>
    ...
    const searchInput =
        document.getElementById('medicine_search');

    const medicineIdInput =
        document.getElementById('medicine_id');

    const resultsBox =
        document.getElementById('medicine_results');

    const selectedMedicine =
        document.getElementById('selected_medicine');
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Validate Medicine Before Submit
    |--------------------------------------------------------------------------
    */
    ...
    form.addEventListener('submit', function (event) {
        ...
        if (!medicineIdInput.value) {
            ...
            alert(
                'Please search and select a valid medicine.'
            );
